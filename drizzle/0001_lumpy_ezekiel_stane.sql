...
ALTER TABLE "goal_log" ALTER COLUMN "date" SET DATA TYPE timestamp with time zone;--> statement-breakpoint
ALTER TABLE "goal_log" ALTER COLUMN "date" SET DEFAULT now();--> statement-breakpoint
...
ALTER TABLE "task" ALTER COLUMN "completed_at" SET DATA TYPE timestamp with time zone;